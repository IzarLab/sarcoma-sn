...
Filename <- '../../../CompiledData/QCdata/SarcomaS956GEX/data_SarcomaS956GEX_genes_300_UMI_600'
pat ='SarcomaS956GEX'
...
#saveRDS(integrated, "S956GEX2000CellSample.rds")

#integrated <- readRDS("S956GEX2000CellSample.rds")
...
#nmf.estimate.rank <- nmf(mat, 2:10, nrun=8)
