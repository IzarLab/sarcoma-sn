...
Filename <- '../../../CompiledData/QCdata/Sarcoma708GEX/data_Sarcoma708GEX_genes_300_UMI_600'
pat ='Sarcoma708GEX'
...
#saveRDS(integrated, "708GEX2000CellSample.rds")

#integrated <- readRDS("708GEX2000CellSample.rds")
