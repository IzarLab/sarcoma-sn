...
#pdf(file = paste0("Testing", pat,"_KINOMO_nmf.pdf"),height = 20,width=20)
#nmf.estimate.rank <- KINOMO(mat, 2:4, nrun=10)
#nmf.estimate.rank <- nmf(mat, 2:4, nrun=10)
#saveRDS(nmf.estimate.rank, paste0(pat,"/",pat,"_KINOMO_nmf_rank_temp_.rds"))
