...
Filename <- '../../../CompiledData/QCdata/Sarcoma322GEX/data_Sarcoma322GEX_genes_300_UMI_600'
pat ='Sarcoma322GEX'
...
#integrated <- subset(x = integrated, downsample = 2000)
#integrated <- integrated[, sample(colnames(integrated), size =2000, replace=F)]                                                                                                                   

#saveRDS(integrated, "322GEX2000CellSample.rds")

#integrated <- readRDS("322GEX2000CellSample.rds")
