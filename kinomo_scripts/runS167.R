...
Filename <- '../../../CompiledData/QCdata/Sarcoma167GEX/data_Sarcoma167GEX_genes_300_UMI_600'
pat ='Sarcoma167GEX'
...
#integrated <- integrated[, sample(colnames(integrated), size =1000, replace=F)]                                                                                                                   
                                                                                                                                                                                                  
#saveRDS(integrated, "S167GEX2000CellSample.rds")                                                                                                                                                  
...
#nmf.estimate.rank <- nmf(mat, 2:8, nrun=12)
#saveRDS(nmf.estimate.rank,paste0(pat,"/",pat,"_KINOMO_nmf_1.rds"))
