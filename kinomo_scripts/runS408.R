...
Filename <- '../../../CompiledData/QCdata/SarcomaS408GEX/data_SarcomaS408GEX_genes_300_UMI_600'
pat ='SarcomaS408GEX'
...
#saveRDS(integrated, "S408GEX2000CellSample.rds")

#integrated <- readRDS("S408GEX2000CellSample.rds")
