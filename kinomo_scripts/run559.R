...
Filename <- '../../../CompiledData/QCdata/Sarcoma559GEX/data_Sarcoma559GEX_genes_300_UMI_600'
pat ='Sarcoma559GEX'
...
#saveRDS(integrated, "559GEX2000CellSample.rds")

#integrated <- readRDS("559GEX2000CellSample.rds")
